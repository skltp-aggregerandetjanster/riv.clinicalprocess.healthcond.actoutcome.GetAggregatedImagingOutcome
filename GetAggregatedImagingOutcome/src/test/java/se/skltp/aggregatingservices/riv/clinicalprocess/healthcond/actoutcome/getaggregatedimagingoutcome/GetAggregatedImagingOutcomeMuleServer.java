...
public class GetAggregatedImagingOutcomeMuleServer {


	public static final String MULE_SERVER_ID   = "GetAggregatedImagingOutcome";
 

	private static final Logger logger = LoggerFactory.getLogger(GetAggregatedImagingOutcomeMuleServer.class);
	...
	public static void main(String[] args) throws Exception {
        ...
        //         Note: Actually enables the spring-beans-profile "soitoolkit-teststubs" in the file "src/main/app/GetAggregatedImagingOutcome-common.xml"
        //
