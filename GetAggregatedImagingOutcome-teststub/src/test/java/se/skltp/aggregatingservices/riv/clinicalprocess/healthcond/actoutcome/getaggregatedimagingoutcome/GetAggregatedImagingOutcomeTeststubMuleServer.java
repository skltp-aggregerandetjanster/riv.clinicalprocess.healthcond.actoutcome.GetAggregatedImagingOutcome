...
public class GetAggregatedImagingOutcomeTeststubMuleServer {


	public static final String MULE_SERVER_ID   = "GetAggregatedImagingOutcome-teststub";
 

	private static final Logger logger = LoggerFactory.getLogger(GetAggregatedImagingOutcomeTeststubMuleServer.class);
